...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --color-approved: #FADADD; /* Palo Rosa para materias aprobadas */
            --color-approved-text: #333; /* Color de texto oscuro para materias aprobadas */
            --color-not-taken: #E5E7EB; /* Plomito para materias no cursadas */
            --color-not-taken-text: #6B7280; /* Gris oscuro para texto de materias no cursadas */
        }
        ...
        .course-card {
            ...
            position: relative;
            overflow: hidden;
            background-color: var(--color-not-taken); /* Color por defecto: plomito */
            color: var(--color-not-taken-text);
        }

        .course-card:hover:not(.approved):not(.disabled) {
            transform: translateY(-3px);
            box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);
        }

        .course-card.approved {
            background-color: var(--color-approved) !important;
            color: var(--color-approved-text) !important;
            text-decoration: none; /* No tachar */
            cursor: default;
        ...
        .course-card.disabled {
            ...
            background-color: var(--color-not-taken); /* Plomito para deshabilitado */
            color: var(--color-not-taken-text);
        }
        ...
        .course-card.enabled {
            ...
            background-color: var(--color-pink-light); /* Rosa bajito cuando está habilitada */
            color: var(--color-text-dark);
        }

        /* Estilo para el overlay de "APROBADA" */
...
<body class="font-sans bg-gray-100 p-4 sm:p-6 md:p-8">
    <div class="max-w-5xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        <header class="bg-pink-dark text-white p-6 rounded-t-lg">
            <h1 class="text-3xl font-bold text-center mb-2">Malla 2025 Economía</h1>
            <p class="text-center text-lg">Haz clic en las materias para marcarlas como "APROBADA" y desbloquear las siguientes.</p>
        </header>
        ...
        <main class="p-6 sm:p-8">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="semestre-1">
                    <div id="habilidades-linguisticas" class="course-card p-4 rounded-lg shadow-md enabled" data-prerequisites="[]" data-opens='["desarrollo-sostenible"]'>
                    ...
                    <div id="analisis-estadistico" class="course-card p-4 rounded-lg shadow-md enabled" data-prerequisites="[]" data-opens='["estadistica-aplicada"]'>
                    ...
                    <div id="analisis-matematico" class="course-card p-4 rounded-lg shadow-md enabled" data-prerequisites="[]" data-opens='["matematicas-financieras", "metodos-matematicos"]'>
                    ...
                    <div id="fundamentos-administracion" class="course-card p-4 rounded-lg shadow-md enabled" data-prerequisites="[]" data-opens='["contabilidad", "derecho-empresarial", "emprendimiento", "administracion-sistemas-procesos"]'>
                    ...
                    <div id="introduccion-ciencia-economica" class="course-card p-4 rounded-lg shadow-md enabled" data-prerequisites="[]" data-opens='["microeconomia", "macroeconomia", "estructura-economica-ecuatoriana", "microeconomia-ii", "macroeconomia-ii", "economia-internacional"]'>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="semestre-2">
                    <div id="etica" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens='["realidad-nacional-politica"]'>
                    ...
                    <div id="metodologia-investigacion" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens='["diseno-evaluacion-proyectos", "proyecto-integrador"]'>
                    ...
                    <div id="contabilidad" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["fundamentos-administracion"]' data-opens='["cuentas-nacionales"]'>
                    ...
                    <div id="fundamentos-marketing" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Fundamentos del Marketing</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Ninguno</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="microeconomia" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["introduccion-ciencia-economica"]' data-opens='["microeconomia-ii"]'>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="semestre-3">
                    <div id="desarrollo-sostenible" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["habilidades-linguisticas"]' data-opens="[]">
                    ...
                    <div id="derecho-empresarial" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["fundamentos-administracion"]' data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Derecho Empresarial</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Fundamentos de Administración</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="matematicas-financieras" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["analisis-matematico"]' data-opens="[]">
                    ...
                    <div id="estadistica-aplicada" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["analisis-estadistico"]' data-opens="[]">
                    ...
                    <div id="macroeconomia" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["introduccion-ciencia-economica"]' data-opens='["macroeconomia-ii"]'>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="semestre-4">
                    <div id="realidad-nacional-politica" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["etica"]' data-opens="[]">
                    ...
                    <div id="diseno-evaluacion-proyectos" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["metodologia-investigacion"]' data-opens="[]">
                    ...
                    <div id="cuentas-nacionales" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["contabilidad"]' data-opens="[]">
                    ...
                    <div id="metodos-matematicos" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["analisis-matematico"]' data-opens='["teoria-juegos-optimizacion"]'>
                    ...
                    <div id="macroeconomia-ii" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["macroeconomia"]' data-opens="[]">
            ...
            <div class="mb-8">
                ...
                <div id="semestre-5" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div id="emprendimiento" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["fundamentos-administracion"]' data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Emprendimiento</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Fundamentos de Administración</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="decisiones-datos-ia" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Decisiones basadas en datos e IA</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Ninguno</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="estructura-economica-ecuatoriana" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["introduccion-ciencia-economica"]' data-opens='["politica-economica-desarrollo"]'>
                    ...
                    <div id="microeconomia-ii" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["microeconomia"]' data-opens='["teoria-desarrollo-economico"]'>
                    ...
                    <div id="econometria-i" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens='["econometria-ii"]'>
            ...
            <div class="mb-8">
                ...
                <div id="semestre-6" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div id="topicos-especiales-economia" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Tópicos Especiales de Economía</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Ninguno</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="historia-economica-mundial" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Historia Económica Mundial</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Ninguno</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="teoria-desarrollo-economico" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["microeconomia-ii"]' data-opens='["economia-internacional"]'>
                    ...
                    <div id="teoria-juegos-optimizacion" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["metodos-matematicos"]' data-opens='["planificacion-economica-desarrollo-prospectivo"]'>
                    ...
                    <div id="econometria-ii" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["econometria-i"]' data-opens="[]">
            ...
            <div class="mb-8">
                ...
                <div id="semestre-7" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div id="politica-economica-desarrollo" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["estructura-economica-ecuatoriana"]' data-opens='["economia-comportamiento"]'>
                    ...
                    <div id="economia-territorial" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Economía Territorial</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Ninguno</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="economia-internacional" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["introduccion-ciencia-economica", "teoria-desarrollo-economico"]' data-opens="[]">
                    ...
                    <div id="planificacion-economica-desarrollo-prospectivo" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["teoria-juegos-optimizacion"]' data-opens="[]">
                    ...
                    <div id="economia-ambiental" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens="[]">
            ...
            <div class="mb-8">
                ...
                <div id="semestre-8" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div id="economia-comportamiento" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["politica-economica-desarrollo"]' data-opens="[]">
                    ...
                    <div id="politica-fiscal" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Política Fiscal</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Ninguno</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="administracion-sistemas-procesos" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["fundamentos-administracion"]' data-opens="[]">
                        <h3 class="font-bold text-pink-800 text-lg mb-2">Administración de Sistemas y Procesos</h3>
                        <p class="text-gray-700 text-sm">Prerrequisitos: Fundamentos de Administración</p>
                        <p class="text-gray-700 text-sm">Abre a: Ninguno</p>
                    </div>
                    <div id="administracion-proyectos" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites="[]" data-opens='["proyecto-integrador"]'>
                    ...
                    <div id="proyecto-integrador" class="course-card p-4 rounded-lg shadow-md disabled" data-prerequisites='["metodologia-investigacion", "administracion-proyectos"]' data-opens="[]">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            let approvedCourses = new Set(); // Changed from passedCourses to approvedCourses
            ...
            const checkPrerequisites = (courseId) => {
                ...
                // Check if all prerequisites are in the approvedCourses set
                return prerequisites.every(prereqId => approvedCourses.has(prereqId));
            };
            ...
            const updateCourseStates = () => {
                courseCards.forEach(card => {
                    ...
                    // If a course is already approved, keep it approved
            ...
            courseCards.forEach(card => {
                card.addEventListener('click', function() {
                    ...
                    // Only allow clicking if the course is enabled and not already approved
                    if (this.classList.contains('enabled') && !this.classList.contains('approved')) {
                        ...
                        approvedCourses.add(courseId); // Add to approved courses
